...
export default async function PlanesPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10">
      ...
      <p className="text-fg/60 mb-10 max-w-xl">
          ...
          return (
            <div
              ...
              className={`p-6 border flex flex-col ${
                highlight ? "bg-navy text-chalk border-navy" : "bg-surface border-fg/10"
              }`}
            >
              {highlight && (
              ...
              <p className={`text-sm mb-4 ${highlight ? "text-chalk/70" : "text-fg/60"}`}>{plan.description}</p>
